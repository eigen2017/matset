 ...
 */
#ifndef RTW_HEADER_re_h_
#define RTW_HEADER_re_h_
#include <math.h>
#include <float.h>
#include <string.h>
#include <stddef.h>
#ifndef re_COMMON_INCLUDES_
# define re_COMMON_INCLUDES_
#include "rtwtypes.h"
...
typedef struct {
  ...
  boolean_T NSampleEnable;             /* '<S2>/N-Sample Enable' */
} B_re_T;
...
typedef struct {
  ...
  uint32_T NSampleEnable_Counter;      /* '<S2>/N-Sample Enable' */
} DW_re_T;
...
extern DW_re_T re_DW;

/* Model entry point functions */
extern void re_initialize(void);
extern void re_step(void);
extern void re_terminate(void);

/* Real-time Model object */
extern RT_MODEL_re_T *const re_M;
 ...
 * '<Root>' : 're'
 * '<S1>'   : 're/Chirp Signal'
 * '<S2>'   : 're/N-Sample Switch'
 */
#endif                                 /* RTW_HEADER_re_h_ */
