...
%------ SPECIFY DATA ------------------------------------------------------
PATH= 'E:\PHY\12lea'; % path, where data are saved
HEADERFILE= 'I01.hea';      % header-file in text format
ATRFILE= 'I01.atr';         % attributes-file in binary format
DATAFILE='I01.dat';         % data-file
...
%------ LOAD BINARY DATA --------------------------------------------------
if dformat~= [212,212],
    error('this script does not apply binary formats different to 212.'); end;
